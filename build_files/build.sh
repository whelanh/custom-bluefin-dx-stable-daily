...
dnf5 install -y tmux kmymoney micro python3-pip r fish fontawesome-fonts-all freetype-devel fribidi-devel zsh java-latest-openjdk-devel gcc gcc-c++ clang llvm sqlitebrowser
